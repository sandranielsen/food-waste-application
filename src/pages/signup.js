      ...
      <section id="${this.id}" class="page">
        ...
        <div class="login_signup_container">
            ...
            <div class="form_container">
              <form>
                <input class="signup_input" id="signup-name" type="text" name="name" placeholder="Type Name">
                <input class="signup_input" id="signup-username" type="text" placeholder="Type email" autocomplete="new-email">
                <input class="signup_input" id="signup-password" type="password" placeholder="Password" autocomplete="new-password">
                <input class="signup_input" id="signup-password-check" type="password" placeholder="Password" autocomplete="new-password">
